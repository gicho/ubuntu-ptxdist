...
RUN apt update && apt install -y --no-install-recommends apt-utils libncurses5-dev gawk flex bison texinfo python-dev g++ dialog lzop autoconf libtool xmlstarlet xsltproc doxygen autopoint
